...
if(isset($_POST['publish_section_button']))
{
    ...
    else
    {
        ...
        session_start();
        $CID = $_SESSION['CID'];
        $sql = "INSERT INTO Section (CID, section, title)
                VALUES ('$CID', '$section_no', '$section_name');";
        ...
        {
            echo "<script type='text/javascript'>alert('Section Couldn\'t be added!');</script>";
...
<head>
    ...
    <link rel="stylesheet" href="Add-Section.css" media="screen">
    ...
    <meta property="og:title" content="Add Section">
...
<section class="u-align-center u-clearfix u-section-1" id="carousel_b796">
    <h2 class="u-text u-text-1"><b>Add Section</b>
    </h2>
            ...
            <div class="u-form u-form-1">
                <form action="#" method="POST" >
                    <div class="u-form-group u-form-name">
                        <label for="name-6797" class="u-label">Section Name</label>
                        <input type="text" placeholder="Enter Section Name" id="name-6797" name="section_name" class="u-border-2 u-border-palette-4-base u-input u-input-rectangle" required="">
                    </div>
                    <div class="u-form-group u-form-group-2">
                        <label for="text-422d" class="u-label">Section Number</label>
                        <input type="text" placeholder="Enter Section Number" id="text-422d" name="section_no" class="u-border-2 u-border-palette-4-base u-input u-input-rectangle">
                    </div>
                    <div class="u-align-center u-form-group u-form-submit">
                        <a href="add_section.php" class="u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-2-light-1 u-palette-2-light-2 u-radius-15 u-btn-1">Publish Section</a>
                        <input type="submit" name="publish_section_button" value="submit" class="u-form-control-hidden">
                    </div>
