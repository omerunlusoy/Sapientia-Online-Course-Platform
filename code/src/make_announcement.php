...
if(isset($_POST['send_button'])){
    ...
    $sql = "INSERT INTO Course_Announcement (IID, CID, date,subject_name,text) 
            VALUES ('$IID','$CID', '$date', '$subject', '$description')";
...
<section class="u-align-center u-clearfix u-section-2" id="carousel_b796">
    <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-1">Make Announcement</h1>
                ...
                <div class="u-form u-form-1">
                    <form action="#" method="POST" >
                        ...
                        <div class="u-form-group u-form-message">
                            ...
                            <textarea placeholder="Enter Announcement" rows="4" cols="50" id="message-6797" name="description" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required=""></textarea>
                        </div>
                        <div class="u-align-center u-form-group u-form-submit">
                            <a href="#" class="u-btn u-btn-round u-btn-submit u-button-style u-palette-2-light-2 u-radius-27 u-btn-1">Announce<br>
                            </a>
