...
if(isset($_POST['send_button'])){
    ...
    $sql = "INSERT INTO Complaint_Entry_Student (SID, CID, subject_title,text,date,refund_request) 
            VALUES ('$SID','$CID', '$subject', '$description', '$date', '$select')";
    ...
    echo "<script type='text/javascript'>alert('You already have 1 active complaint!');</script>";
...
<head>
    ...
    <title>Fill a complaint - student</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
    <link rel="stylesheet" href="Fill-a-complaint---student.css" media="screen">
    ...
    <meta property="og:title" content="Fill a complaint - student">
...
<section class="u-clearfix u-section-1" id="sec-7411">
...
<section class="u-align-center u-clearfix u-section-2" id="sec-c02d">
    <div class="u-clearfix u-sheet u-sheet-1">
                ...
                <div class="u-form u-form-1">
                    <form action="#" method="POST" >
                        ...
                        <div class="u-form-date u-form-group">
                            ...
                            <input type="date" placeholder="" id="email-6797" name="date" value='<?php echo date('Y-m-d');?>' class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="required">
                        </div>
                        <div class="u-form-group u-form-message">
                            <label for="message-6797" class="u-label">Description</label>
                            <textarea placeholder="" rows="4" cols="50" id="message-6797" name="description" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required=""></textarea>
                        </div>
                        <div class="u-form-group u-form-radiobutton u-form-group-4">
                            <div class="u-form-radio-button-wrapper">
                                <input type="radio" name="radiobutton1" value="Refund Request">
                                <label class="u-label" for="radiobutton1">Refund Request</label>
                                <br>
                                <input type="radio" name="radiobutton2" value="Other">
                                <label class="u-label" for="radiobutton2">Other</label>
                                <br>
                            </div>
                        </div>
